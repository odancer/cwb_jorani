...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `stationedorg` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `stationedunit` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `bidname` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `manager` (`manager`),
