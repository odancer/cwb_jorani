...
<thead>
  ...
  <?php foreach ($entitleddays as $days) { ?>
    <tr data-id="<?php echo $days['id'] ?>">
      <td>
        <a href="#" onclick="delete_entitleddays(<?php echo $days['id'] ?>);" title="<?php echo lang('entitleddays_user_index_thead_tip_delete');?>"><i class="fa fa-times fa-2x" style="color:red;"></i></a>
        &nbsp;<a href="#" onclick="copy_entitleddays(<?php echo $days['id'] ?>);" title="<?php echo lang('entitleddays_user_index_thead_tip_copy');?>"><i class="fa fa-copy fa-2x" style="color:black;"></i></a>
        &nbsp;<a href="#" onclick="show_edit_entitleddays(<?php echo $days['id'] ?>);" title="<?php echo lang('entitleddays_user_index_thead_tip_edit');?>"><i class="fa fa-pencil fa-2x" style="color:blue;"></i></a>
      </td>
        ...
        $.ajax({
            ...
            data: { user_id: <?php echo $id; ?>,
              ...
              htmlRow = '<tr data-id="' + id + '">' +
                        '<td><a href="#" onclick="delete_entitleddays(' + id + ');" title="<?php echo lang('entitleddays_user_index_thead_tip_delete');?>"><i class="fa fa-times fa-2x" style="color:red;"></i></a>' +
                        '&nbsp;&nbsp;<a href="#" onclick="copy_entitleddays(' + id + ');" title="<?php echo lang('entitleddays_user_index_thead_tip_copy');?>"><i class="fa fa-copy fa-2x" style="color:black;"></i></a>' +
                        '&nbsp;&nbsp;<a href="#" onclick="show_edit_entitleddays(' + id + ');" title="<?php echo lang('entitleddays_user_index_thead_tip_edit');?>"><i class="fa fa-pencil fa-2x" style="color:blue;"></i></a></td>' +
