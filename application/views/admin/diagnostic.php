  ...
  <div class="tab-pane" id="balance">
    ...
    <?php foreach ($leaveBalance as $balance): 
        ...
        <tr>
            ...
            <td>
                <a target="_blank" href="<?php echo base_url();?>hr/counters/employees/<?php echo $balance['employee'];?>"><i class="fa fa-info fa-2x" style="color:black;"></i></a>
                <a target="_blank" href="<?php echo base_url();?>entitleddays/user/<?php echo $balance['employee'];?>"><i class="fa fa-edit fa-2x" style="color:blue;"></i></a>
                <?php echo $balance['user_label'];?>
            </td>
            <td>
                <a target="_blank" href="<?php echo base_url();?>entitleddays/contract/<?php echo $balance['employee'];?>"><i class="fa fa-edit fa-2x" style="color:blue;"></i></a>
